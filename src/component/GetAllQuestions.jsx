    ...
    <>
      <div class="mx-auto my-10 grid max-w-screen-xl grid-cols-1 px-2 text-blue-800 sm:px-20 lg:grid-cols-3">
        <div class="col-span-1 flex flex-col justify-center text-center sm:text-left md:pr-10">
          <h1 class="mb-6 text-4xl">DSA Interview Preparation</h1>
          <p class="text-blue-900">
            "DSA Interview Preparation" implies a platform for storing and revising
            solved DSA questions and other Core CS subjects
          </p>
          <div class="my-5">
            <button
